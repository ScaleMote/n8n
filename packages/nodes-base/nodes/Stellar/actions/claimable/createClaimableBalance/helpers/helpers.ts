...
import type ClaimantPredicate from 'stellar-sdk';
import type { IPredicate } from '../../../entities/IPredicate';
...
export function buildClaimantsList(claimantsValues: IClaimants['values']) {
