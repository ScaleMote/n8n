...
import type { TransactionType } from '../../../transport/types';
import { TransactionsRequest } from '../../../transport/requests/TransactionsRequest/TransactionsRequest';
import type { ITransactionsRequest } from '../../../transport/requests/TransactionsRequest/ITransactionsRequest';
...
export async function getTransactions(this: IExecuteFunctions) {
	...
	return transactionsProvider.getTransactions(transactionsRequest);
}
