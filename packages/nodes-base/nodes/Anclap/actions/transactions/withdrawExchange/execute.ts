...
import type { IWithdrawExchangeRequest } from '../../../transport/requests/WithdrawRequest/IWithdrawExchangeRequest';
...
export async function withdrawExchange(this: IExecuteFunctions) {
	...
	const getSep6WithdrawExchangeInfo = async () => {
		...
		return sep6.getWithdrawExchange(withdrawExchangeRequest);
	};

	return getSep6WithdrawExchangeInfo();
}
