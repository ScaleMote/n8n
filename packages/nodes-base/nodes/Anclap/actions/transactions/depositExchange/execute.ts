...
import type { IDepositExchangeRequest } from '../../../transport/requests/DepositRequest/IDepositExchangeRequest';
...
export async function depositExchange(this: IExecuteFunctions) {
	...
	const getSep6DepositExchangeInfo = async () => {
		...
		return sep6.getDepositExchange(depositExchangeRequest);
	};

	return getSep6DepositExchangeInfo();
}
