import type { INaturalPersonFileIdRequest } from './INaturalPersonFileIdRequest';

export class NaturalPersonFileIdRequest implements INaturalPersonFileIdRequest {
