import type { INaturalPersonFieldsRequest } from './INaturalPersonFieldsRequest';

export class NaturalPersonFieldsRequest implements INaturalPersonFieldsRequest {
	familyName?: string;
